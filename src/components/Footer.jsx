...
export function Footer() {
  return (
    <footer>
      <div className="mx-auto max-w-7xl py-16 md:flex md:items-center md:justify-between">
        <div className="flex justify-center space-x-6 md:order-2">
          <a
            href="//github.com/caseysoftware/webhooks.fyi"
        ...
        <div className="mt-8 flex justify-center md:order-1 md:mt-0">
