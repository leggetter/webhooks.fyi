...
export function Footer() {
    return (
        <footer>
        <div className="max-w-7xl mx-auto py-16 md:flex md:items-center md:justify-between">
          <div className="flex justify-center space-x-6 md:order-2">
            <a href="//twitter.com/ngrokHQ" className="text-gray-400 hover:text-gray-500">
            ...
            <a href="//github.com/ngrok/webhooks.fyi" className="text-gray-400 hover:text-gray-500">
