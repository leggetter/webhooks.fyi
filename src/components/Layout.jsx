...
function Header({ navigation }) {
  ...
  return (
    ...
    >
      ...
      <div className="relative flex w-[48px] items-center lg:w-auto">
        <Link href="/">
      ...
      <div className="-my-5 mr-6 flex flex-grow justify-center sm:mr-8 md:mr-0">
        <Search />
      </div>

      <div className="relative flex basis-0 items-center justify-end space-x-6 sm:space-x-8">
        ...
        <Link href="https://hookdeck.com/?ref=webhooksfyi" target="_sponsor">
          <a className="dark:text-slate-300">
            ...
            <div className="flex items-center space-x-2 hover:fill-sky-500">
              <span className="hidden flex-auto whitespace-nowrap lg:inline-block">
                Supported by
              </span>
              <span className="relative h-[29px] w-[40px] overflow-hidden md:w-[178px] md:overflow-visible">
                <LogoSponsor />
              </span>
            </div>
          </a>
